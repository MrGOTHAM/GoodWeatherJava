package com.acg.goodweatherjava.utils;
...
import com.acg.goodweatherjava.databinding.DialogCityBinding;
import com.acg.goodweatherjava.db.bean.Province;
import com.acg.goodweatherjava.ui.adapter.AdministrativeClickCallback;
import com.acg.goodweatherjava.ui.adapter.AreaAdapter;
import com.acg.goodweatherjava.ui.adapter.CityAdapter;
import com.acg.goodweatherjava.ui.adapter.ProvinceAdapter;
 ...
 * @Description 加载获取到的城市数据，然后显示出来，再点击Item是根据区域类型做不同的处理
 * @Version 1.0.0
