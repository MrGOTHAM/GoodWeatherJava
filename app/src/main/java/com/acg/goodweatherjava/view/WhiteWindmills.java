package com.acg.goodweatherjava.view;
...
/**
 * @Classname WhiteWindmills
 * @Description 风车自定义view
 * @Version 1.0.0
...
public class WhiteWindmills extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mPivotRadius = (float) wid / (float) 40;
    ...
    private void drawWindBlade(Canvas canvas) {
        ...
        // 画三角形扇叶
        mPath.moveTo(mCenterX, mCenterY - mPivotRadius); // 此点为多边形起点
    ...
    public void startRotate() {
        stop();
        mHandler.sendEmptyMessageDelayed(0, 10);    // 指定多少毫秒后发送空消息
    }
