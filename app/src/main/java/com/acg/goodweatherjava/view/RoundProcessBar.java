...
public class RoundProcessBar extends View {
    ...
    public RoundProcessBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs,0);
    }

    public RoundProcessBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
